...
import (
	...
	"CRD-chain/swarm"
	bzzapi "CRD-chain/swarm/api"
	swarmmetrics "CRD-chain/swarm/metrics"
	"CRD-chain/swarm/tracing"
	sv "CRD-chain/swarm/version"
...
// This init function sets defaults so cmd/swarm can run alongside evertrust.
func init() {
...
var app = utils.NewApp(gitCommit, "CRD evertrust & Ethereum Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2018-2019 The CRD evertrust & Ethereum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//evertrust only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for evertrust and swarm
