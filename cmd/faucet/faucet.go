...
var (
	...
	captchapoints  = flag.String("captcha.points", "", "Recaptcha site key to authenticate client side")
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://evertrust-chain/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
