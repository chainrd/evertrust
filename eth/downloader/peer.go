...
type LightPeer interface {
	...
	RequestLatest() error
	SendBlockPath(BlockPath []common.Hash) error
	RequestNormalLatest() error
}
...
func (w *lightPeerWrapper) SendBlockPath(BlockPath []common.Hash) error {
	return nil
}
func (w *lightPeerWrapper) RequestNormalLatest() error {
	return nil
}

func (w *lightPeerWrapper) RequestIsland() error {
...
//CRD随机选一个peer
func (ps *peerSet) RandPeer() *peerConnection {
	ps.lock.RLock()
	defer ps.lock.RUnlock()

	var (
		randPeer *peerConnection
	)
