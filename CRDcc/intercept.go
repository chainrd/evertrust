...
var handingMap = make(map[common.Address]chan int, 1)

func isHanding(nameHash common.Address) chan int {
...
func getStreamService() (string, error) {
	once.Do(
		func() {
			...
			value := CRDData.GetRaw("baap-base", "initConfig")
