...
const (
	CRDS_CREATE_DOMAIN CRDS = 0
	CRDS_UPDATE_DOMAIN CRDS = 1
	CRDS_DELETE_DOMAIN CRDS = 2
	CRDS_GET_DOMAIN    CRDS = 3
	CRDS_CREATE_KEY    CRDS = 4
	CRDS_UPDATE_KEY    CRDS = 5
	CRDS_DELETE_KEY    CRDS = 6
	CRDS_GET_KEY       CRDS = 7
)

var CRDS_name = map[int32]string{
	0: "CREATE_DOMAIN",
	1: "UPDATE_DOMAIN",
	2: "DELETE_DOMAIN",
	3: "GET_DOMAIN",
...
var CRDS_value = map[string]int32{
	"CREATE_DOMAIN": 0,
	"UPDATE_DOMAIN": 1,
	"DELETE_DOMAIN": 2,
	"GET_DOMAIN":    3,
...
func (x CRDS) String() string {
	return proto.EnumName(CRDS_name, int32(x))
}

func (CRDS) EnumDescriptor() ([]byte, []int) {
...
func init() {
	proto.RegisterEnum("protos.CRDS", CRDS_name, CRDS_value)
	proto.RegisterType((*DomainItem)(nil), "protos.DomainItem")
	proto.RegisterType((*KeyItem)(nil), "protos.KeyItem")
}

func init() { proto.RegisterFile("CRDsafe_op.proto", fileDescriptor_a967d8cb84ed25a9) }
