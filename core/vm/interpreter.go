...
type Interpreter interface {
	...
	//add by liangc for wasm >>>>
	// 部署 wasm 合约之前需要检查和注入代码，以便解释器对其进行预处理
	//PreContractCreation([]byte, *Contract) ([]byte, error)
	// 部署 wasm 合约成功之前最后的预处理
...
// add by liangc for wasm >>>>
//func (in *EVMInterpreter) PreContractCreation(code []byte, c *Contract) ([]byte, error) { return code, nil }
//func (in *EVMInterpreter) PostContractCreation(code []byte) ([]byte, error) { return code, nil }
// add by liangc for wasm <<<<
