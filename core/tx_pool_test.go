...
func TestTransactionDoubleNonce(t *testing.T) {
	...
	if replace, _, err := pool.add(tx1, false); err != nil || replace {
		t.Errorf("first transaction insert failed (%v) or reported replacement (%v)", err, replace)
	}
	if replace, _, err := pool.add(tx2, false); err != nil || !replace {
...
func TestTx(t *testing.T) {
	txStr := ""
	txByt, err := hex.DecodeString(txStr)
	if err != nil {
		t.Fatal(err)
	}
	var tx *types.Transaction
	err = rlp.DecodeBytes(txByt, &tx)
	if err != nil {
		t.Fatal(err)
	}
