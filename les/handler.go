...
func (pm *ProtocolManager) handle(p *peer) error {
	...
	if pm.lightSync && pm.peers.Len() >= pm.maxPeers {
...
func (pc *peerConnection) SendBlockPath(BlockPath []common.Hash) error {
	return nil
}

func (pc *peerConnection) RequestNormalLatest() error {
	return nil
}
