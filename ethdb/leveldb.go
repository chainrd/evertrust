...
// NewLDB returns a wrapped LevelDB object. The namespace is the prefix that the
// metrics reporting should use for surfacing internal stats.
func NewLDB(file string, cache int, handles int, namespace string) (*LDatabase, error) {
...
func (db *LDatabase) NewIterator() Iterator {
...
// not exist).
func (db *LDatabase) NewIteratorWithStart(start []byte) Iterator {
	return db.db.NewIterator(&util.Range{Start: start}, nil)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (db *LDatabase) NewIteratorWithPrefix(prefix []byte) Iterator {
	return db.db.NewIterator(util.BytesPrefix(prefix), nil)
}

// Stat returns a particular internal stat of the database.
func (db *LDatabase) Stat(property string) (string, error) {
...
func (db *LDatabase) Compact(start []byte, limit []byte) error {
