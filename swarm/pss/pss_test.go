...
import (
	...
	"CRD-chain/p2p/simulations"
	"CRD-chain/p2p/simulations/adapters"
	"CRD-chain/rpc"
	"CRD-chain/swarm/network"
	"CRD-chain/swarm/state"
	whisper "CRD-chain/whisper/whisperv5"
)
...
func enableMetrics() {
	...
	go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 1*time.Second, "http://localhost:8086", "metrics", "swarm.", "admin", "admin", map[string]string{
		"host": "test",
	}, false)
}
