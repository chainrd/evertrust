...
go test -race -v ./swarm/pss -cpu 4 -run TestNetwork
  ...
  4   CRD-chain/swarm/pss.(*Pss).forward.func1()
  5       /Users/nonsense/code/src/CRD-chain/swarm/pss/pss.go:654 +0x44f
  6   CRD-chain/swarm/network.(*Kademlia).eachConn.func1()
  7       /Users/nonsense/code/src/CRD-chain/swarm/network/kademlia.go:350 +0xc9
  8   CRD-chain/pot.(*Pot).eachNeighbour.func1()
  9       /Users/nonsense/code/src/CRD-chain/pot/pot.go:599 +0x59
  ...

 28
 29 Previous write at 0x00c424d456a0 by goroutine 829:
 30   CRD-chain/swarm/pss.(*Pss).Run()
 31       /Users/nonsense/code/src/CRD-chain/swarm/pss/pss.go:192 +0x16a
 32   CRD-chain/swarm/pss.(*Pss).Run-fm()
 33       /Users/nonsense/code/src/CRD-chain/swarm/pss/pss.go:185 +0x63
 34   CRD-chain/p2p.(*Peer).startProtocols.func1()
 35       /Users/nonsense/code/src/CRD-chain/p2p/peer.go:347 +0x8b
 ...
```
