...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/evertrust.ipc",
			endpoint:    "/data/testnet/evertrust.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/evertrust.ipc",
			endpoint:    "/data/testnet/evertrust.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/evertrust.ipc",
			endpoint:    "/data/testnet/evertrust.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/evertrust.ipc",
			endpoint:    "/data/testnet/evertrust.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
