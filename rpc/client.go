...
func Dial(rawurl string, proxy... string) (*Client, error) {
	return DialContext(context.Background(), rawurl, proxy...)
}
...
func DialContext(ctx context.Context, rawurl string, proxy... string) (*Client, error) {
