...
进入 [CRD-unity](https://test.iaas.CRD.ltd/) 平台 -> 点击**DappStore** -> 点击**发布合约**

### 通过evertrust-driver SDK进行部署和调用

部署solidity：

```java
package ltd.CRD.evertrust.driver.example;

import com.fasterxml.jackson.databind.ObjectMapper;
import ltd.CRD.evertrust.driver.core.CallTransaction;
import ltd.CRD.evertrust.driver.core.Transaction;
import ltd.CRD.evertrust.driver.exception.BlockchainDriverException;
import ltd.CRD.evertrust.driver.http.HttpClient;
import ltd.CRD.evertrust.driver.util.Constants;
import ltd.CRD.evertrust.driver.util.DriverUtil;
import ltd.CRD.evertrust.eckey.util.ECKeyUtil;
...
import ltd.CRD.evertrust.driver.evertrustSolidityDriver;
import ltd.CRD.evertrust.driver.exception.BlockchainDriverException;
import ltd.CRD.evertrust.driver.util.Constants;
import ltd.CRD.evertrust.driver.util.DriverUtil;
import ltd.CRD.evertrust.eckey.util.ECKeyUtil;
...
public class SolidityClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        evertrustSolidityDriver driver = new evertrustSolidityDriver();
...
//
//        //get balance  basepoints
//         BigDecimal bg = getBalanceBasepoints("0xa768c134e9342d0811c555466d04ff0809b07c97");
//         System.out.println(bg.toString());

    }

    public static void deploySolidity(evertrustSolidityDriver driver) throws BlockchainDriverException {
     ...
     */
    public static void deploySol(evertrustSolidityDriver driver) throws BlockchainDriverException {
        byte[] payload = Hex.decode("");
     ...
     * @throws BlockchainDriverException
     */
    public static void deploySolAttachJWT(evertrustSolidityDriver driver) throws BlockchainDriverException {
        Map<String, byte[]> meta = new HashMap<>();
    ...
    /**
     * getBalanceBasepoints
     * @param address
     * @return
     * @throws IOException
     */
    public static BigDecimal getBalanceBasepoints(String address) throws IOException {
        String url = BAAP_BLOCKCHAIN_RPC;
