...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "evertrust.ipc", false, filepath.Join(os.TempDir(), "evertrust.ipc")},
		{"data", "evertrust.ipc", false, "data/evertrust.ipc"},
		{"data", "./evertrust.ipc", false, "./evertrust.ipc"},
		{"data", "/evertrust.ipc", false, "/evertrust.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "evertrust.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "evertrust.ipc", true, `\\.\pipe\geth.ipc`},
